...
public class fonction_Dave {
	...
	public static void main(String[] args) throws IOException, JSONException {
		...
		String nb_sujet = Input_Keyboard.Get_String("Veuillez saisir le nombre des sujets vous voulez chercher:");
		...
		ArrayList<TagsAnswerers> TagsAnswerers_List_new = Operation_BDD.Select_Table_PluralTagsAnswerers(Conn_BDD, choix);
